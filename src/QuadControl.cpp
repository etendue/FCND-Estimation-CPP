...
V3F QuadControl::RollPitchControl(V3F accelCmd, Quaternion<float> attitude, float collThrustCmd)
{
  ...
  float R13_target = CONSTRAIN(accelCmd[0]/c, -maxTiltAngle,maxTiltAngle);
  float R23_target = CONSTRAIN(accelCmd[1]/c,-maxTiltAngle,maxTiltAngle);
  ...
  float b_x_c_dot = this->kpBank * (R13_target - R13);
  float b_y_c_dot = this->kpBank * (R23_target - R23);
